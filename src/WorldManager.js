...
export default class WorldManager {
    ...
    async loadWorld(path) {
        ...
        if (terrain) {
            this.createTerrainCollision(terrain);
        }
        ...
        if (carBody) {
            ...
            // Hide the original visual body if we're creating a new one in Vehicle
            // or use it as the chassis mesh. For now, we'll just return it for positioning.
        }
    ...
    createTerrainCollision(terrain) {
        ...
        if (geometries.length > 0) {
            ...
            console.log('Static terrain collision created');
        }
    }
}
